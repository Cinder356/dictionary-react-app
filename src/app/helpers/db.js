...
import { DB_NAME, DB_VERSION, MODULES_DICTS_STORE_NAME, MODULES_METADATA_STORE_NAME, USER_STATS_STORE_NAME } from "../consts/dbConsts";
  ...
  if (!dbPromise)
    dbPromise = openDB(DB_NAME, DB_VERSION, {
      upgrade(db) {
        ...
        if (!db.objectStoreNames.contains(USER_STATS_STORE_NAME)) {
          db.createObjectStore(USER_STATS_STORE_NAME, { keyPath: 'id' })
        }
      },
    })
  return dbPromise
